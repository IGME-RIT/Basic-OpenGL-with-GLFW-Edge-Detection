...
int main(int argc, char **argv)
{
	...
	// Initialize window
	GLFWwindow* window = glfwCreateWindow(viewportDimensions.x, viewportDimensions.y, "And the sobel prize goes to...", nullptr, nullptr);
    ...
    invertFrag.InitFromFile("../shaders/sobelFrag.glsl", GL_FRAGMENT_SHADER);
